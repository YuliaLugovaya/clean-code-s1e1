...
var incompleteTaskHolder = document.getElementById("todo-list__incomplete-tasks");//ul of #todo-list__incomplete-tasks
var completedTasksHolder = document.getElementById("todo-list__completed-tasks");//todo-list__completed-tasks
...
var createNewTaskElement = function (taskString) {
  ...
  label.className = 'todo-list__task todo-list__text';
...
var addTask = function () {
  ...
  //Create a new list item with the text from the #todo-list__new-task:
...
var editTask = function () {
  ...
  var editInput = listItem.querySelector('.todo-list__task[type=text]');
  var label = listItem.querySelector(".todo-list__text");
...
var taskCompleted = function () {
  ...
  //Append the task list item to the #todo-list__completed-tasks
  var listItem = this.parentNode;
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var checkBox = taskListItem.querySelector(".todo-list__checkbox[type=checkbox]");
